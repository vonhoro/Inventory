...
module.exports = (upload) => {
  ...
  /*
    ...
    */
  imageRouter.route("/images").get((req, res, next) => {
  ...
  /* 
  GET: All files on image colecio
  
 */

  imageRouter.route("/images/show/all").get((req, res, next) => {
  ...
  // getting one file by their filename on image collection

  imageRouter.route("/images/show/:filename").get((req, res, next) => {
  ...
  /*
    ...
    */
  imageRouter.route("/images/delete/:id").post((req, res, next) => {
